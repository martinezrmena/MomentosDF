...
namespace AppCarnesDF.Helpers.CustomRender
{
    public class ExtendedEntry : Entry
    {
        ...
        public static readonly BindableProperty IsSelectedProperty = BindableProperty.Create(propertyName: "IsSelected", returnType: typeof(bool), declaringType: typeof(ExtendedEntry), defaultValue: default(bool));
